function CourseListRow({ isHeader = false, textFirstCell = '', textSecondCell = null, id = null, isSelected = false, changeRow = null }) {
  let trContent = <>
    <td className="border border-gray-400 pl-[8px]">
      <input type="checkbox" checked={isSelected} onChange={(e) => changeRow(id, e.target.checked)} />
      { textFirstCell }
    </td>
